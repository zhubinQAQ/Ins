...
_C.MODEL.CONDINST.MASK_HEAD.MAPPING_RATIO = 1.0
_C.MODEL.CONDINST.MASK_HEAD.GRID_NUM = [4, ]
_C.MODEL.CONDINST.MASK_HEAD.USE_MULTI = False
_C.MODEL.CONDINST.MASK_HEAD.SPLIT = [-1, 0, 2, 4]
_C.MODEL.CONDINST.MASK_HEAD.CONCAT = False
_C.MODEL.CONDINST.MASK_HEAD.LOSS_WEIGHTS = [1.0, 1.0, 1.0]
